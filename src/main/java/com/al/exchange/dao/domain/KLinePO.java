...
public class KLinePO implements OnlyKey {
    ...
    public KLinePO(String measurement, String exchange, String symbol, String unit, BigDecimal open, BigDecimal close, BigDecimal high, BigDecimal low, BigDecimal volume, Long timestamp, String type, String onlyKey) {
